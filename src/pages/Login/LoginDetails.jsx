    ...
    import schemaJson from "./Login.schema.json";
    
    import { listLogins } from "../../services/Login.service";
    
    const LoginDetails = ({ apiURL = "" }) => {
      ...
      return (
        <div className="pageDetailView flex-column d-flex">
          ...
          <ViewDetails getDetails={listLogins} apiURL={apiURL} modelName={schemaJson?.name} schemaJson={schemaJson} />
